 ...
 */
public class AdminMGRRemoteTest {

    private MtsClient mtsClient = null;

    private AdminMGRClient adminMGR;
    private final static String SRC_SYSTEM_ID_REGEX = "[a-zA-z0-9|:|\\.]*";
    private final static String BUILD_STRING_REGEX = "[a-zA-z0-9| |\\+|\\-|\\.]* - \\d{12}";
    ...
    public void setUp() {
        try {
            ...
            adminMGR = mtsClient.getManager(AdminMGRClient.class);
     ...
     */
    @Test
    public void testGetSrcSystemId() throws Exception {
        System.out.println("testing getSrcSystemId");
        Pattern pattern = Pattern.compile(SRC_SYSTEM_ID_REGEX);
        String result = adminMGR.getSrcSystemId();
    ...
    /**
     * Test of getBuildInfo method, of class AdminMGRRemote.
     * @throws java.lang.Exception
     */
    @Test
    public void testGetBuildInfo() throws Exception {
        System.out.println("testing getBuildInfo");
        Pattern pattern = Pattern.compile(BUILD_STRING_REGEX);
        String result = adminMGR.getBuildInfo();
        System.out.println("getBuildInfo result: " + result);
        Matcher matcher = pattern.matcher(result);
        assertTrue(matcher.matches());
    }
}
